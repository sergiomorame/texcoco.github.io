...
map.getView().fit([-11027181.071009, 2200120.860437, -10983842.522320, 2221220.474206], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Texcoco</h2>';
        return titleElement;
    })(),
