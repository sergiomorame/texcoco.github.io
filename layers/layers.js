...
lyr_Positron_0.setVisible(true);lyr_texcoco_1.setVisible(true);lyr_colonias_2.setVisible(true);lyr_puntos_3.setVisible(true);
var layersList = [lyr_Positron_0,lyr_texcoco_1,lyr_colonias_2,lyr_puntos_3];
